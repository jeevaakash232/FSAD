...
function initializeCharts() {
    ...
    const systemConfigs = {
        'smart-home':      { min: 0, max: 50,  color: '#a855f7' },
        'industrial':      { min: 0, max: 250, color: '#3b82f6' },
        'environmental':   { min: 0, max: 200, color: '#10b981' },
        'vehicle':         { min: 0, max: 200, color: '#f59e0b' }
    };
            ...
            options: {
                ...
                scales: {
                    x: {
                        display: true,
                        grid: { display: false },
                        ticks: { font: { size: 10 }, maxTicksLimit: 5, maxRotation: 0, color: 'rgba(255,255,255,0.3)' }
                    },
                    y: {
                        display: true,
                        min: config.min,
                        max: config.max,
                        ticks: { font: { size: 10 }, maxTicksLimit: 5, color: 'rgba(255,255,255,0.3)', callback: v => v.toFixed(0) },
